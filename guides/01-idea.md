...
6. After writing `01_idea/idea.md` and `07_paper_latex/intro.tex`, ask the user
   exactly 10 calibration questions before moving to Step 2.
...
10 post-write calibration questions have been asked. Ask which direction the
user wants to pursue before building the knowledge base.
